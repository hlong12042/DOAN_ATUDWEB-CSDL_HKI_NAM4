    ...
    <script src="sources/js/sb-admin-2.min.js"></script>
    ...
    <script src="sources/js/demo/chart-pie-demo.js"></script>
    
        <!-- Page level plugins -->
    <script src="sources/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="sources/vendor/datatables/dataTables.bootstrap4.min.js"></script>
